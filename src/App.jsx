...
const MoreNotifications = lazy(() => import("./page/dashboard/child/notifications/MoreNotifications"))
const SeeNotifications = lazy(() => import("./page/dashboard/child/notifications/SeeNotifications"))
